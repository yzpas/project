...
new Vue({
    ...
    watch: {
        cur: function(oldValue , newValue){
            this.$http.post(Url+'/back2/deal/index',{page:arguments[0],start_time:this.strartTime,end_time:this.endTime,search_key:this.searchKey,status:this.selectTo},{emulateJSON:true}).then(function(res){
    ...
    created:function(){
        var $this = this;
        this.$http.post(Url+'/back2/deal/index',{},{emulateJSON:true}).then(function(res){
            $this.list = res.data.list;
    ...
    methods:{
        ...
        soso:function(){
            ...
            this.$http.post(Url+'/back2/deal/index',{
                page:this.cur,
